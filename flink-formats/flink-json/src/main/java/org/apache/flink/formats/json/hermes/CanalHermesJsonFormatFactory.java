 ...
 */
public class CanalHermesJsonFormatFactory implements DeserializationFormatFactory,
	SerializationFormatFactory {

	public static final String IDENTIFIER = "canal-hermes-json";
	...
	public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
		...
		Configuration realConfig = null;
		try {
			Field realFormat = formatOptions.getClass()
				.getDeclaredField("backingConfig");
			realFormat.setAccessible(true);
			realConfig = (Configuration) realFormat.get(formatOptions);
		} catch (NoSuchFieldException e) {
			e.printStackTrace();
		} catch (IllegalAccessException e) {
			e.printStackTrace();
		}
		final String topic = realConfig.get(TOPIC);
		...
		return new DecodingFormat<DeserializationSchema<RowData>>() {
			...
			public DeserializationSchema<RowData> createRuntimeDecoder(
				...
				return new CanalHermesJsonDeserializationSchema(
					rowType,
					rowDataTypeInfo,
					ignoreParseErrors,
